...
CREATE TABLE IF NOT EXISTS games (
 id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, game_id VARCHAR(100) NOT NULL UNIQUE, slug VARCHAR(160) NULL UNIQUE, name VARCHAR(160) NOT NULL, category VARCHAR(80) NOT NULL DEFAULT 'Arcade', rating DECIMAL(2,1) NOT NULL DEFAULT 0.0, thumbnail_url TEXT NULL, description TEXT NULL, tags JSON NULL, badge VARCHAR(40) NULL, game_url TEXT NULL, plays BIGINT UNSIGNED NOT NULL DEFAULT 0, featured BOOLEAN NOT NULL DEFAULT FALSE, developer_id VARCHAR(100) NULL,
